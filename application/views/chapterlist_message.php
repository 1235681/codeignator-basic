                  ...
                  <div class="card sortable-item">
                    <div class="card-header" id="heading<?= $chapter['id'] ?>">
                      <h5 class="mb-0">
                        ...
                        <a href="http://localhost/CodeigniterDemo/index.php/ChapterList/chapterupdateid?id=<?= $chapter['id'] ?>">editChapter</a>
                        <i class="fas fa-edit"></i></button>
                          <button class="btn btn-sm btn-danger" onclick="deleteChapter(<?= $chapter['id'] ?>)"><i class="fas fa-trash-alt"></i></button>
                        </span>
                      </h5>
                    </div>
